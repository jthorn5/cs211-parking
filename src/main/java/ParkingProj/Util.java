...
public class Util {
	...
	public static boolean checkDist(LatLng orig, LatLng dest, int feet) {
		return haversineFeet(orig.lat,orig.lng,dest.lat,dest.lng) <= feet;
	}
	public static String toReadable(long sec) {
		System.out.println("init sec: "+sec);
		long min = sec / 60;
		sec = sec % 60;
